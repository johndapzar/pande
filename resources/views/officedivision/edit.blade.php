					...
					@foreach($divisionAll as $division)
					    ...
					    <td align="left" class="action text-center">
					    	{!! Form::open(array('url'=>route('officedivision.destroy', array($division->id)),'method'=>'delete')) !!}
								<a href="{{route('officedivision.edit', array($division->id))}}" class="btn btn-xs btn-success tooltip-top" title="Edit ce" style="padding:5px 10px 5px 10px;"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;&nbsp;
	   ...
	   {!! $divisionAll !!} 
		...
		<div class="col-md-4">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="col-md-12">
					{!! Form::model($divisionById, ['route'=>['officedivision.update',$divisionById->id],'method'=>'patch','class'=>'form-horizontal']) !!}
			                        ...
			                        @foreach($chiefAll as $id => $officeZone)
			                            ...
			                            <?php
			                                ...
			                                foreach  ($officeCircle as $office_circle_id => $office_circle_name) {
			                                	if ($divisionById->office_circle_id==$office_circle_id)
			                                	{
			                                		$select="selected";
			                                    ...
			                                    echo "<option value='$office_circle_id' $select >$office_circle_name</option>";
			                                }
			                            ?> 
			                            </optgroup>
			                        @endforeach
