	   ...
	   {!! $subAll !!} 
		...
		<div class="col-md-4">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="col-md-12">
					{!! Form::model($subById, ['route'=>['officesubdivision.update',$subById->id],'method'=>'patch','class'=>'form-horizontal']) !!}
			                        ...
			                        @foreach($chiefAll as $id => $officeZone)
			                            ...
			                            <?php
			                                ...
			                                foreach ($officeCircle as $office_circle_id => $office_circle_name) {
			                                	...
			                                	if ($subById->office_circle_id==$office_circle_id)
			                                	{
			                                		$select="selected";
			               ...
			               {!! Form::label('Division') !!}
			                    <select name="office_division_id" class="form-control input-sm" required id="office_division_id">
			                        ...
			                        <?php
			                            ...
			                            foreach ($officeDivision as $office_division_id => $name) {
			                            	if ($subById->office_division_id==$office_division_id)
			                                	{
			                                		$select="selected";
			                                ...
			                                echo "<option value='$office_division_id' $select >$name</option>";
			                            }
			                        ?>
			                    </select>
			            </div>
