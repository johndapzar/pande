					...
					@foreach($circleAll as $circle)
					    ...
					    <td align="left" class="action text-center">
					    	{!! Form::open(array('url'=>route('officecircle.destroy', array($circle->id)),'method'=>'delete')) !!}
								<a href="{{route('officecircle.edit', array($circle->id))}}" class="btn btn-xs btn-success tooltip-top" title="Edit Circle" style="padding:5px 10px 5px 10px;"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;&nbsp;
	   ...
	   {!! $circleAll !!} 
		...
		<div class="col-md-4">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="col-md-12">
					{!! Form::model($circleById, ['route'=>['officecircle.update',$circleById->id],'method'=>'patch','class'=>'form-horizontal']) !!}
						...
						<div class="form-group">
							...
							{!! Form::select('chief_engineer_id',$chiefAll,'',['class'=>'form-control']) !!}
